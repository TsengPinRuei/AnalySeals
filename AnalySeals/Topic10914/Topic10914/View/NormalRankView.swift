...
struct NormalRankView: View
{
    ...
    //MARK: 獎牌
    private func setMedal(rank: Int) -> String
    {
        switch(rank)
        {
            case 0:
    ...
    private func setSchool() -> [(String, String)]
    {
        ...
        {
            case "Academic":
                return self.worldRank.AcademicNormal
            case "QS":
                return self.worldRank.QSNormal
            case "THE":
                return self.worldRank.THENormal
            case "USNews":
                return self.worldRank.USNormal
            case "Center":
                return self.worldRank.CenterNormal
            default:
                return []
        }
    }
