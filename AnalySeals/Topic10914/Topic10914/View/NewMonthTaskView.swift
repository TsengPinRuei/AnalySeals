...
struct NewMonthTaskView: View
{
    ...
    var body: some View
    {
        VStack(alignment: .leading)
        {
            ...
            VStack(alignment: .leading, spacing: 30)
            {
                ...
                VStack(alignment: .leading, spacing: 20)
                {
                    ...
                    HStack(spacing: 10)
                    {
                        ...
                        {color in
                            Circle()
                                .fill(MonthTask(title: "", type: "", tint: color).setColor())
                                .background
                                {
                                    Circle()
                                        .stroke(lineWidth: 5)
            ...
            Button
            {
                let task: MonthTask=MonthTask(title: self.title, type: self.type, date: self.date, tint: self.tint)
